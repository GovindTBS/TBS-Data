xmlport 50142 "SEPA ACH pain.001.001.03"
{
    Caption = 'SEPA ACH pain.001.001.03';
    ...
    begin
        ...
        ControlSum := Format(GenJnlBuffer.Amount, 0, '<Standard Format,9>');
        ...
        DebtorName := BankAccount."ACH Intake Name";
